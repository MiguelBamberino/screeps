    ...
    loadNodes(){
        return {
            a: new RoomNode('Alpha', {
                retreatSpot:rp(25,25,'W21S22'),anchor:rp(17,37,'W21S22'),buildFast: false,spawnFacing:LEFT,armAnchor:rp(19,41,'W21S22'),
            ...
            b: new RoomNode('Beta', {
                retreatSpot:rp(25,25,'W22S17'),anchor:rp(13,15,'W22S17'),buildFast: false,spawnFacing:LEFT,
